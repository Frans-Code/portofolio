    ...
    <section className="contact container section" id="contact">
      ...
      <div className="contact__container grid">
        <div className="contact__info">
          <h3 className="contact__title">Let's talk about</h3>
            <p className="contact__details">If you have any questions,<br /> Send me an email. 👋</p>
        </div>
        ...
        <form action="" className="contact__form">
          ...
          <button className='btn'>Send <i class="ri-mail-send-line"></i></button>
        </form>
      </div>
    </section>
  )
