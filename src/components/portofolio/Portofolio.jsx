  ...
  return (
    <section className="work container section" id="work">
      ...
      <div className="work__filters">
        <span className={items === Menu ? "work__item active-link" : "work__item"} onClick={() => setItems(Menu)} >All</span>
        <span className={items === Menu ? "work__item active-link" : "work__item"} onClick={() => filterItem("Creative")}>Creative</span>
